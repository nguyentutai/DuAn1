        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <?php { ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="parent-product" aria-label="Default select example">
                            ...
                            foreach ($listdm as $categogy) { ?>
                                <option value="<?= $categogy['id_category'] ?>" <?= ($id_category == $categogy['id_category'])?'selected':'' ?> ><?= $categogy['name_category'] ?></option>
                            <?php
                            }
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="origin_price" value="<?= $cost_product ?>" class="form-control" id="" placeholder="Nhập vào giá gốc">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-2">
                        <img src="../upload/<?= $image_product ?>" class="img-fluid mt-3 text-center" alt="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">
