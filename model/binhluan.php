<?php 
    ...
    function list_comment_product($id){
        $sql = "SELECT comment.id_comment, comment.content_comment,account.id_account,comment.status_comment,account.image_account, account.user,product.id_product, comment.date_comment FROM `comment` 
