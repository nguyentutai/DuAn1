            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="content row">
                    <div class="mb-3 col-md-6">
                        <label for="formGroupExampleInput" class="form-label fw-semibold fs-5">Tên sản
                            phẩm</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nhập vào tên sản phẩm">
                    </div>
                    <div class="mb-3 col-md-6">
                        <label for="" class="form-label fw-semibold fs-5">Số lượng</label>
                        <input type="number" class="form-control" id="" placeholder="Nhập vào số lượng">
                    </div>
                </div>
                ...
                <div class="content1 row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="" placeholder="Nhập vào giá gốc">
                    </div>
                    <div class="col-md-4">
                        <label for="" class="form-label fw-semibold fs-5">Giá khuyễn mãi</label>
                        <input type="number" class="form-control" id="" placeholder="Nhập vào giá khuyễn mãi">
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-md-6">
                        <label for="exampleFormControlTextarea1" class="form-label fw-semibold fs-5">Nhập mô
                            tả sản phẩm</label>
                        <textarea class="form-control content" id="exampleFormControlTextarea1" placeholder="Nhập mô tả sản phẩm" rows="7.5"></textarea>
                    </div>
                    <div class="col-md-3">
